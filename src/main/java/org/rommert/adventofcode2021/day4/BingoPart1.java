...
public class BingoPart1 {
  ...
  public static void main(String[] args) {
    ...
    List<BingoCard> bingoCards = new InputParser<BingoCard>("\n\n")
        .convertInput(cardInput, BingoPart1::convertToCard);
    ...
    for (Integer newNumber : numbers) {
      ...
      if (winner != null) {
        System.out.println("YAY a winner after drawing nr " + newNumber);
        System.out.println(winner);
        Integer sumOfUncheckedNumbers = winner.bingoNumberRows.stream()
  ...
  private static class BingoCard {
    ...
    private List<List<BingoNumber>> createColumns(List<List<BingoNumber>> bingoNumberRows) {
      ...
      IntStream intStream = IntStream.of(0, bingoNumberRows.get(0).size() - 1);
      intStream.forEach(position -> {
